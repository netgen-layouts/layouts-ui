define(['underscore', 'backbone', 'app', 'extended/params_parser'], function(_, Backbone, App, params_parser){
  ...
  return Backbone.View.extend({
    ...
    initialize: function(options){
      ...
      //Delegate event to App;
      this.on('fh', function(){
        App.trigger('fh', {view: this});
      });
    ...
    load: function(data){
      ...
      var tmp_data = {f: data.f || (App.complex_filters && App.complex_filters.serialize_state) || {}};
    ...
    render_child: function(){
      App.trigger('render:before_child', {view: this});
